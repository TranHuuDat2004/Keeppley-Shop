...
<body>
  <form method="post" action="login_vn.php">
    ...
    <fieldset id="password-field">
      <legend style="color:red">Mật khẩu</legend>
      <span id="show-password-container">
        <span></span> Hiện mật khẩu
      </span>
      <div>
