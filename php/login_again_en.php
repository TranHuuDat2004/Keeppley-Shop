...
<body>
    ...
    <form method="post" action="login.php">
        <svg width="250" height="250" viewBox="0 0 250 250" xmlns="http://www.w3.org/2000/svg" role="img"
            ...
            <desc id="desc">Cartoon of a Caucasian woman smiling, and wearing black glasses and a purple shirt with
                white
                collar.</desc>
            <defs>
                <clipPath id="scene">
        ...
        <fieldset id="email-field" class="with-placeholder">
            <legend style="color:red">Username</legend>
            <div>
        ...
        <fieldset id="password-field">
            <legend style="color:red">Password</legend>
            <span id="show-password-container">
                <span></span> Show Password
            </span>
            <div>
                <input type="password" name="password" id="password" autocomplete="nope" autocorrect="off"
