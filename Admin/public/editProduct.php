          ...
          <div class="content">
            ...
            <div class="form-group text-gray-700 dark:text-gray-200">
              ...
              <select id="type" class="form-control" name="p_age">
                ...
                <option value="0-12 months" <?php if ($row['p_age'] == '0-12 months')
                  echo 'selected'; ?>>0-12 months
                </option>
                <option value="1-2 years" <?php if ($row['p_age'] == '1-2 years')
                  echo 'selected'; ?>>1-2 years</option>
                <option value="3+ years" <?php if ($row['p_age'] == '3+ years')
                  echo 'selected'; ?>>3+ years</option>
                <option value="5+ years" <?php if ($row['p_age'] == '5+ years')
                  echo 'selected'; ?>>5+ years</option>
                </optgroup>
              </select>
            </div>
            ...
            <div class="form-group text-gray-700 dark:text-gray-200">
              ...
              <select id="type" class="form-control" name="p_provider">
                ...
                <option value="Frog Leaf" <?php if ($row['p_provider'] == 'Frog Leaf')
                  echo 'selected'; ?>>Frog Leaf
                </option>
                <option value="dun dun dun" <?php if ($row['p_provider'] == 'dun dun dun')
                  echo 'selected'; ?>>dun dun dun
                </option>
                <option value="Cloud Frog" <?php if ($row['p_provider'] == 'Cloud Frog')
                  echo 'selected'; ?>>Cloud Frog
                </option>
                <option value="DiNo" <?php if ($row['p_provider'] == 'DiNo')
                  echo 'selected'; ?>>DiNo</option>
                <option value="Baby Logo" <?php if ($row['p_provider'] == 'Baby Logo')
                  echo 'selected'; ?>>Baby Logo
                </option>
                <option value="Cookie" <?php if ($row['p_provider'] == 'Cookie')
                  echo 'selected'; ?>>Cookie</option>
                <option value="BarBie" <?php if ($row['p_provider'] == 'BarBie')
                  echo 'selected'; ?>>BarBie</option>
                </optgroup>
              </select>
            </div>
            ...
            <div class="form-group text-gray-700 dark:text-gray-200">
              ...
              <select id="type" class="form-control" name="p_type">
                ...
                <optgroup label="Natural">
                  <option value="Wood" <?php if ($row['p_type'] == 'Wood')
                    echo 'selected'; ?>>Wood</option>
                  <option value="Cotton" <?php if ($row['p_type'] == 'Cotton')
                    echo 'selected'; ?>>Cotton</option>
                  <option value="Wool" <?php if ($row['p_type'] == 'Wool')
                    echo 'selected'; ?>>Wool</option>
                  <option value="Clay" <?php if ($row['p_type'] == 'Clay')
                    echo 'selected'; ?>>Clay</option>
                  <option value="Bamboo" <?php if ($row['p_type'] == 'Bamboo')
                    echo 'selected'; ?>>Bamboo</option>
                  <option value="LEGO" <?php if ($row['p_type'] == 'LEGO')
                    echo 'selected'; ?>>LEGO</option>
                </optgroup>
                <optgroup label="Man-Made">
                  <option value="Plastic" <?php if ($row['p_type'] == 'Plastic')
                    echo 'selected'; ?>>Plastic</option>
                  <option value="Metal" <?php if ($row['p_type'] == 'Metal')
                    echo 'selected'; ?>>Metal</option>
                  <option value="Polyester" <?php if ($row['p_type'] == 'Polyester')
                    echo 'selected'; ?>>Polyester
                  </option>
                  <option value="Rubberized Plastic" <?php if ($row['p_type'] == 'Rubberized Plastic')
                    echo 'selected'; ?>>
                    Rubberized Plastic</option>
                  <option value="Foam" <?php if ($row['p_type'] == 'Foam')
                    echo 'selected'; ?>>Foam</option>
                </optgroup>
              </select>
            </div>
            ...
            <div class="form-group text-gray-700 dark:text-gray-200">
              ...
              <textarea class="form-control" id="description" name="p_description" rows="4"
                cols="50"><?php echo $row['p_description']; ?></textarea>
            </div>
