...
<body>
  ...
  <div style="padding-bottom: 400px;" class="form-container container mt-5">
    ...
    <h2 class="stext-121 my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
      ...
      <div class="content">
        ...
        <div class="form-group text-gray-700 dark:text-gray-200">
          ...
          <input class="form-control" id="amount" name="d_amount" type="text" placeholder="Amount">
        </div>
        ...
        <div class="form-group text-gray-700 dark:text-gray-200">
          ...
          <input class="form-control" id="start-date" name="d_start_date" type="date">
        </div>

        <div class="form-group text-gray-700 dark:text-gray-200">
          <label for="end-date">End Date</label>
          <input class="form-control" id="end-date" name="d_end_date" type="date">
        </div>
